...
export default function AcademicsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white pb-32 relative overflow-x-hidden selection:bg-amber-500 selection:text-black">
      {/* Premium Top Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-[radial-gradient(circle_at_50%_0%,#1a1a24_0%,transparent_70%)] pointer-events-none -z-10" />
      ...
      <div className="max-w-[720px] mx-auto px-6 pt-12 space-y-10 relative z-10">
        ...
        <header className="flex items-center justify-between animate-in fade-in slide-in-from-bottom-8 duration-700 fill-mode-forwards">
          <div className="space-y-1">
            <div className="flex items-center gap-2 mb-2 group cursor-pointer" onClick={() => router.back()}>
              ...
              <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest group-hover:text-zinc-300">Back</span>
            </div>
            <h1 className="text-4xl font-extrabold tracking-tight bg-gradient-to-br from-amber-300 via-amber-500 to-amber-600 bg-clip-text text-transparent">
              Academic Vault
            </h1>
          ...
          <button 
            ...
            className={cn(
              ...
              selectedType === "ALL" 
                ...
                : "bg-white/[0.03] border-white/[0.08] text-zinc-400 hover:bg-white/[0.06] hover:text-white"
            )}
          >
            All
          </button>
        ...
        <section className="space-y-6">
          <div className="flex items-center justify-between animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 fill-mode-forwards opacity-0">
            ...
            {filteredFiles.map((file, idx) => (
              ...
              >
                <div className="flex items-center gap-5 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-[9px] font-black text-zinc-400 uppercase tracking-widest bg-white/[0.05] px-2 py-0.5 rounded-md border border-white/[0.05]">
                        {file.docType}
                      </span>
                ...
                <div className="flex items-center gap-3 pl-4">
                  ...
                  <button className="w-11 h-11 rounded-full bg-white/[0.03] text-zinc-500 border border-transparent flex items-center justify-center transition-all hover:bg-white/[0.1] hover:text-white hover:scale-110 hidden sm:flex">
